...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("In a nutshell, generics enable types (classes and interfaces) to be parameters when defining classes, interfaces and methods.");
        ...
        int num = 12;
        String a = "Day la string cdj djhdh";
